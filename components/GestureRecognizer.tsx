...
export function GestureRecognizer({ isDark = false, offlineMode = false }: { isDark?: boolean; offlineMode?: boolean }) {
  ...
  }, [results, isRunning, audioUnlocked, audioMuted, lastSpokenGesture, speak, detectionMode, wordBuffer, sentenceBuffer, controlGestureHoldStart, currentControlGesture, selectedLanguage, useAIVision, smartModeEnabled]);
